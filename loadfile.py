...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.baudRateComboBox.addItems(['250000','MIDI','9600', '19200', '38400', '57600', '115200' ])
    ...
    def select_file(self):
        ...
        self.file_path, _ = QFileDialog.getOpenFileName(self, "选取文件", "", "下载文件 (*.bg)", options=options)
